CREATE OR REPLACE PACKAGE oph_tools IS
  /*****************************************************************************
  * Partition Tools
  *
  * Author:    Thomas Krahn
  ...
  *            oph_types 0.9.26
  *****************************************************************************/
  gc_module_version CONSTANT module_admin.t_module_version := '0.9.10';
  ...
  ****************************************************************************/
  ...
  /****************************************************************************/
  PROCEDURE convert_v2_tab_to_ts_tab(v2_tab_in IN oph_types.t_varchar2_tab, ts_tab_out OUT NOCOPY oph_types.t_timestamp_tab);

  /****************************************************************************/
  /* Convert t_literal_format_tab into table of t_ts_wltz_high_value_tab
  /****************************************************************************/
  PROCEDURE convert_lf_tab_to_ts_hv_tab(lf_tab_in IN oph_types.t_literal_format_tab, ts_hv_tab_out OUT NOCOPY oph_types.t_ts_wltz_high_value_tab);

  /*******************************************************************************
  * Convert varchar2 comma seperated list into table of varchar2(4000)
  *******************************************************************************/
  PROCEDURE convert_v2_to_v2_tab(v2_in IN VARCHAR2, v2_tab OUT oph_types.t_varchar2_tab);
END oph_tools;
/
CREATE OR REPLACE PACKAGE BODY oph_tools IS
  ...
  ******************************************************************************/
  PROCEDURE convert_v2_tab_to_ts_tab(v2_tab_in IN oph_types.t_varchar2_tab, ts_tab_out OUT NOCOPY oph_types.t_timestamp_tab) IS
  ...
  * Convert t_literal_format_tab into table of t_ts_wltz_high_value_tab
  ******************************************************************************/
  PROCEDURE convert_lf_tab_to_ts_hv_tab(lf_tab_in IN oph_types.t_literal_format_tab, ts_hv_tab_out OUT NOCOPY oph_types.t_ts_wltz_high_value_tab) IS
  ...
  * Convert varchar2 comma seperated list into table of varchar2(4000)
  *******************************************************************************/
  PROCEDURE convert_v2_to_v2_tab(v2_in IN VARCHAR2, v2_tab OUT NOCOPY oph_types.t_varchar2_tab) IS
    v_module_action log_admin.t_module_action := 'convert_v2_to_v2_tab';
    n_pos           PLS_INTEGER;
    l_v             oph_types.long_varchar := v2_in;
  BEGIN
    n_pos := instr(l_v, ',');
    WHILE n_pos != 0 LOOP
